...
|RF-007| O administrador do sistema poderá visualizar, alterar, excluir  e cadastrar os itens do estoque| ALTA | 
|RF-008| O usuário cliente, poderá visualizar as compras realizadas após a finalização do pedido | MÉDIA | 
|RF-009| O usuário poderá alterar os itens do carrinho de compra até a finalização do pedido | BAIXA | 
